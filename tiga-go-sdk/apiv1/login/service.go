...
func (s *defaultService) GetAuthentication(ctx context.Context, url string) (*AuthenticationRequest, error) {
...
func (s *defaultService) ReplyAuthenticationSuccess(ctx context.Context, req *AuthenticationRequest, success *AuthenticationCallback) error {
	return s.postCallback(ctx, req.Links.SuccessCallbackUrl, success)
}

func (s *defaultService) ReplyAuthenticationFailure(ctx context.Context, req *AuthenticationRequest, failure *commonv1.ErrorCallback) error {
	return s.postCallback(ctx, req.Links.ErrorCallbackUrl, failure)
}
