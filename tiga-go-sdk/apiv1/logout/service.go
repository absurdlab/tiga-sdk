...
func (s *defaultService) GetLogout(ctx context.Context, url string) (*LogoutRequest, error) {
	var ar LogoutRequest
...
func (s *defaultService) ReplyLogout(ctx context.Context, req *LogoutRequest, payload *LogoutCallback) error {
